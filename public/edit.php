        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="save.php" method="post">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="name" id="name" value="<?= $landing['name'] ?>">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="slug" id="slug" value="<?= $landing['slug'] ?>">
                                <div class="invalid-feedback">
                                    Field cannot be empty
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="page_title" id="page_title" value="<?= $landing['page_title'] ?>">
                                <div class="invalid-feedback">
                                    Field cannot be empty
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" value="1" class="custom-control-input" name="active" id="active" <?= $landing['active'] == 1 ? 'checked' : '' ?>>
                                ...
                                <div class="d-flex">
                                    <select id="legal-select" class="form-control w-90 form-select" name="legal_id" id="legal_id">
                                        ...
                                        <?php foreach($legals as $legal) { ?>
                                            <option value="<?= $legal['id'] ?>" <?= $landing['legal_id'] == $legal['id'] ? 'selected' : '' ?>><?= $legal['name'] ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-select" name="country_id" id="country_id">
                                    ...
                                    <?php foreach($countries as $country) { ?>
                                        <option value="<?= $country['id'] ?>" <?= $landing['country_id'] == $country['id'] ? 'selected' : '' ?>><?= $country['iso_code'] ?></option>
                                    <?php } ?>
                                </select>
                                <div class="invalid-feedback">
                                    Field cannot be empty
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control required" name="tracking" maxlength="191" id="tracking" value="<?= $landing['redirect'] ?>">
                                <div class="invalid-feedback">
                                    Field cannot be empty
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="databowl_id" maxlength="191" id="databowl_id" value="<?= $landing['databowl_id'] == 0 ? "" : $landing['databowl_id'] ?>">
                                <div class="invalid-feedback">
                                    Field cannot be empty
                                </div>
                            </div>
                    ...
                    <input type="hidden" class="d-none" name="action" id="action" value="update">
                    <input type="hidden" class="d-none" name="id" id="id" value="<?= $_GET["id"] ?>">

                    <div class="d-flex justify-content-between w-100">
                        <a class="btn btn-secondary" href="../">Go back</a>
                        <button class="btn btn-success" id="submit-button">Save</button>
                    </div>
