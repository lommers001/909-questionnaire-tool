...
(function (navigator, window, document, $) {
    ...
    var Trumbowyg = function (editorElem, options) {
        ...
        t.btnsDef = {
            ...
            continueWithoutConsent: {
                fn: 'insertContinueWithoutConsent'
            }
        };
    ...
    Trumbowyg.prototype = {
        ...
        insertContinueWithoutConsent: function () {
            var t = this,
                documentSelection = t.doc.getSelection(),
                selectedRange = documentSelection.getRangeAt(0),
                node = documentSelection.focusNode,
            ...
            t.saveRange();
            if(t.range.startOffset == t.range.endOffset) return;
            console.log(t);
            let vtext = t.range.toString();
            var link = $(['<a href="', url, '">', vtext, '</a>'].join(''));
            console.log("EXEC 5");
            t.range.deleteContents();
            console.log("EXEC 6");
            t.range.insertNode(link[0]);
