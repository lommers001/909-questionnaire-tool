...
namespace App\Services\PostcodeNl;


use App\Services\PostcodeNl\Exception\AuthenticationException;
use App\Services\PostcodeNl\Exception\BadRequestException;
use App\Services\PostcodeNl\Exception\CurlException;
use App\Services\PostcodeNl\Exception\CurlNotLoadedException;
use App\Services\PostcodeNl\Exception\ForbiddenException;
use App\Services\PostcodeNl\Exception\InvalidJsonResponseException;
use App\Services\PostcodeNl\Exception\InvalidPostcodeException;
use App\Services\PostcodeNl\Exception\InvalidSessionValueException;
use App\Services\PostcodeNl\Exception\NotFoundException;
use App\Services\PostcodeNl\Exception\ServerUnavailableException;
use App\Services\PostcodeNl\Exception\TooManyRequestsException;
use App\Services\PostcodeNl\Exception\UnexpectedException;
...
class Client
{
	...
	public function __construct(string $key, string $secret, string $platform)
	{
		...
		curl_setopt($this->_curlHandler, CURLOPT_CAINFO, "cacert.pem");
		curl_setopt($this->_curlHandler, CURLOPT_CAPATH, "cacert.pem");
